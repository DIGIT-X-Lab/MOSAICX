...
5. `#63 [EXTX-05]` MultiChainComparison adjudication + Refine field-level repair (`done`)
6. `#64 [EXTX-06]` Deterministic validators for units/dates/ranges/null semantics (`in_progress`)
